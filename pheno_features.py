...
PFT_FEATURES = ['Resting_SaO2_P2','FEV1_FVC_post_P2' ] ##features
PFT_NAMES = [r'$\mathbf{Resting\ SaO_{2}}$', r'$\mathbf{FEV_{1}/FVC}$'] ## names to be printed on plot
...
CT_order_names = [
                'Age_P2','BMI_P2',
                'C(gender)[T.2]','C(race)[T.2]', 'C(smoking_status_P2)[T.2.0]',  # 'gender', 'race',
                "C(Disease, Treatment(reference='Control'))[T.Asthma]",
                "C(Disease, Treatment(reference='Control'))[T.COPD]",
                "C(Disease, Treatment(reference='Control'))[T.ACO]",
